      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button
          ...
          className={cn(
            ...
            canCallNow && isMyTurn
              ? "chunky-button bg-loss-crimson text-rose-950 shadow-[0_4px_0_0_#9f1239] hover:brightness-110"
        ...
        <button
          ...
          className={cn(
            ...
            isMyTurn && gameState.turnStage === 'start' && validDrop
              ? "chunky-button bg-action-emerald text-emerald-950 shadow-[0_4px_0_0_#064e3b] hover:brightness-110"
              : "bg-muted text-muted-foreground border border-border cursor-not-allowed opacity-60"
          )}
        >
        ...
        <button
          ...
          className={cn(
            ...
            isMyTurn && gameState.turnStage === 'dropped'
              ? "chunky-button bg-primary text-emerald-950 shadow-[0_4px_0_0_#002117] hover:brightness-110"
              : "bg-muted text-muted-foreground border border-border cursor-not-allowed opacity-60"
          )}
        >
